...
input_file = f"d:\\LEARNING\\DECEPTICONS-NET\\NewsEffect\\tickers\\{ticker}\\master_{ticker}_articles.jsonl"
output_file = f"d:\\LEARNING\\DECEPTICONS-NET\\NewsEffect\\tickers\\{ticker}\\processed_{ticker}_articles.jsonl"

def analyze_financial_content(content):
    """Send content to Ollama and get structured analysis"""
    prompt = f"""
    Analyze this financial news content and return ONLY a JSON object with these exact fields:
    - market_impact: (string) "positive", "negative", or "neutral"
